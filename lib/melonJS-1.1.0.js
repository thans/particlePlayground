    ...
    /** @scope me.Renderable.prototype */
    {
        ...
        init : function (pos, width, height) {
            ...
            */
            ...
            me.Rect.prototype.init.apply(this, [pos, width, height]);
        ...
        draw : function (context, color) {
            ...
            me.Rect.prototype.draw.apply(this, [context, color]);
        }
    });
...
(function () {
    ...
    /** @scope me.SpriteObject.prototype */
    {
        ...
        init : function (x, y, image, spritewidth, spriteheight) {
            ...
            // call the super constructor
            me.Renderable.prototype.init.apply(this, [new me.Vector2d(x, y),
    ...
    /** @scope me.AnimationSheet.prototype */
    {
        ...
        init : function (x, y, settings) {
            ...
            me.SpriteObject.prototype.init.apply(this, [x, y, settings.image, settings.spritewidth, settings.spriteheight, this.spacing, this.margin]);
                ...
                if (this.current.nextFrame <= 0) {
                    ...
                    if (this.current.idx === 0 && this.resetAnim)  {
                        ...
                        // if function (callback) call it
                            ...
                            this.setAnimationFrame(this.current.idx);
                            me.SpriteObject.prototype.update.apply(this, [dt]);
                            return false;
                        }
                    }
                    ...
                    this.current.nextFrame = this.current.animationspeed;
                    return me.SpriteObject.prototype.update.apply(this, [dt]) || true;
                }
            }
            return me.SpriteObject.prototype.update.apply(this, [dt]);
        }
    });
})();
...
(function () {
    ...
    /** @scope me.Viewport.prototype */ {
        ...
        init : function (minX, minY, maxX, maxY) {
            ...
            me.Renderable.prototype.init.apply(this, [new me.Vector2d(minX, minY), maxX - minX, maxY - minY]);
        ...
        getBounds: function (rect) {
            return me.Renderable.prototype.getBounds.apply(this, [rect]);
        },
...
(function () {
    ...
    /** @scope me.GUI_Object.prototype */
        ...
        init : function (x, y, settings) {
            ...
            me.SpriteObject.prototype.init.apply(this, [x, y,
...
(function () {
    ...
    /** @scope me.ObjectEntity.prototype */
    {
        ...
        init : function (x, y, settings) {
            ...
            me.Renderable.prototype.init.apply(this, [this.pos,
                        settings.width,
                        settings.height]);
        ...
        getBounds : function (rect) {
            if (!this.shapes.length) {
                ...
                this.addShape(me.Renderable.prototype.getBounds.apply(this, [rect]).translate(-this.pos.x, -this.pos.y));
            }
    ...
    /** @scope me.CollectableEntity.prototype */
    {
        ...
        init : function (x, y, settings) {
            // call the super constructor
            me.ObjectEntity.prototype.init.apply(this, [x, y, settings]);
...
(function () {
    ...
    var ProgressBar = me.Renderable.extend({
        ...
        init: function (v, w, h) {
            me.Renderable.prototype.init.apply(this, [v, w, h]);
    ...
    var IconLogo = me.Renderable.extend({
        init : function (x, y) {
            me.Renderable.prototype.init.apply(this, [new me.Vector2d(x, y), 100, 85]);
        },
    ...
    var TextLogo = me.Renderable.extend({
        // constructor
        init : function (w, h) {
            me.Renderable.prototype.init.apply(this, [new me.Vector2d(), w, h]);
...
(function () {
    ...
    /** @scope me.Font.prototype */ {
        ...
        init : function (font, size, fillStyle, textAlign) {
            ...
            me.Renderable.prototype.init.apply(this, [this.pos, 0, this.fontSize.y]);
        },
...
(function (TMXConstants) {
    ...
    me.Tile = me.Rect.extend({
        ...
        init : function (x, y, w, h, gid) {
             ...
             */
            this.transform = null;
            me.Rect.prototype.init.apply(this, [new me.Vector2d(x * w, y * h), w, h]);
...
(function (TMXConstants) {
    ...
    me.ColorLayer = me.Renderable.extend({
        ...
        init: function (name, color, z) {
            // parent constructor
            me.Renderable.prototype.init.apply(this, [new me.Vector2d(0, 0), Infinity, Infinity]);
    ...
    me.ImageLayer = me.Renderable.extend({
        ...
        init: function (name, width, height, imagesrc, z, ratio) {
            ...
            me.Renderable.prototype.init.apply(this, [new me.Vector2d(0, 0), width, height]);
    ...
    me.TMXLayer = me.Renderable.extend({
        ...
        init: function (tilewidth, tileheight, orientation, tilesets, zOrder) {
            // super constructor
            me.Renderable.prototype.init.apply(this, [new me.Vector2d(0, 0), 0, 0]);
...
(function (TMXConstants) {
    ...
    me.TMXTileMap = me.Renderable.extend({
        ...
        init: function (levelId) {
            ...
            me.Renderable.prototype.init.apply(this, [new me.Vector2d(), 0, 0]);
        },
...
(function () {
    ...
    /** @scope ParticleContainer */
    {
        ...
        init: function (emitter) {
            // call the super constructor
            me.ObjectContainer.prototype.init.apply(this);
        ...
        draw : function (context, rect) {
            if (this.children.length > 0) {
                ...
                me.ObjectContainer.prototype.draw.apply(this, [context, rect]);
...
(function () {
    ...
    /** @scope me.Particle.prototype */
    {
        ...
        init : function (emitter) {
            // Call the super constructor
            me.Renderable.prototype.init.apply(this, [emitter.getRandomPoint(), emitter.image.width, emitter.image.height]);
